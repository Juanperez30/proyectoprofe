    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <p><h2 style="font-size:1.7vw" class="page-section- text-center lead">Ingrese a una de las categorias para conocer el trabajo de los estudiantes.</h2></p>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><img alt="Brand" src="assets/img/portfolio/verde.png" width="50"></div>
                    <div class="divider-custom-line"></div>
                </div>
...
<!--                    <tbody><?=cargarTabla($conexion); ?></tbody>
                    <table action="conexion.php" method="post">
                        <thead>
                            ...
                            <th id="descripcion" name="descripcion">descripcion</th>
